...
public class Main {
//// Cerinta 2 - Vector de titulari cititi din fisierul clienti.csv
    private static Titular[] clienti;
    //// Cerinta 3 - Lista de depozite citite din fisierul depozite.csv
...
//            System.out.println(contCurent);
            ...
            //2. Să se citească din fișierul clienti.csv informațiile despre
            // clienți titulari de conturi.
            //Informațiile sunt structurate pe linii, câte o
            // linie pentru un obiect Titular.
            // Obiectele vor fi memorate într-un
            //vector de tip Titular[].
...
// Cerinta 3:           Citire depozite
            //3. Să se creeze listă de depozite de tip List<Depozit>
            // cu elemente de tip Depozit citite dintr-un fișier text Depozite.csv.
            citireDepozite();
            ...
            //// Cerinta 4 - Printare depozite in EURO in fisier text
//
            System.out.println("Depozite in Euro: <Euro.csv>");
            print("Euro.csv");


//5. Să se salveze lista de depozite în fișierul depozite.dat (Serializarea).
            String fisierOutput = "Depozite.dat";
//            salvare(fisierOutput);

            //6.Cerinta 6 - Restaurare lista de depozite (Deserializare)
...
//         Cerinta 7.  Cautare depozite dupa cod contract
...
//            Cerinta 7:Sortare dupa un criteriu oarecare folosind Comparator
...
//            Creare comparator
            ...
            //// Cerinta 7 - Cautare binara dupa comparator
...
//Cerinta 6 - Restaurare lista de depozite (Deserializare)
...
//4. Să se printeze într-un fișier text depozitele citite la punctul 2,
// care sunt în Euro. Vor fi salvate numele
//titularului, codul de contract și valoarea
...
// Cerinta 2.
// Să se citească din fișierul clienti.csv informațiile despre
//            // clienți titulari de conturi.
//            //Informațiile sunt structurate pe linii, câte o
//            // linie pentru un obiect Titular.
//            // Obiectele vor fi memorate într-un
